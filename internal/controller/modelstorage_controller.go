...
import (
	...
	"sxwl/cpodoperator/pkg/modelhub"
)
...
//+kubebuilder:rbac:groups=cpod.sxwl.ai,resources=modelstorages/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cpod.sxwl.ai,resources=modelstorages/finalizers,verbs=update
